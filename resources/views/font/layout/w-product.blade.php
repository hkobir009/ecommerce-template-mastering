										...
										<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Women's Wear</label>
											<ul>
												<li><input type="checkbox" id="item-0-0" /><label for="item-0-0">Ethnic Wear</label>
													<ul>
														<li><a href="{{url('womans_product')}}">Shirts</a></li>
														<li><a href="{{url('womans_product')}}">Caps</a></li>
														<li><a href="{{url('womans_product')}}">Shoes</a></li>
														<li><a href="{{url('womans_product')}}">Pants</a></li>
														<li><a href="{{url('womans_product')}}">SunGlasses</a></li>
														<li><a href="{{url('womans_product')}}">Trousers</a></li>
													</ul>
												</li>
