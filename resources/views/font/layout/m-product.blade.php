					...
					<div class="container">
						<div class="product-agileinfo-grids w3l">
							<div class="col-md-3 product-agileinfo-grid">
										...
										<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><span></span>Men's Wear</label>
											<ul>
												<li><input type="checkbox" id="item-0-0" /><label for="item-0-0">Ethnic Wear</label>
													<ul>
														<li><a href="{{url('mans_product')}}">Shirts</a></li>
														<li><a href="{{url('mans_product')}}">Caps</a></li>
														<li><a href="{{url('mans_product')}}">Shoes</a></li>
														<li><a href="{{url('mans_product')}}">Pants</a></li>
														<li><a href="{{url('mans_product')}}">SunGlasses</a></li>
														<li><a href="{{url('mans_product')}}">Trousers</a></li>
													</ul>
												</li>
								...
								<div class="top-rates">
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="{{url('single')}}"><img class="img-responsive " src="{{asset("/")}}images/r.jpg" alt=""></a>
										</div>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="{{url('single')}}"><img class="img-responsive " src="{{asset("/")}}images/r1.jpg" alt=""></a>
										</div>
										<div class="recent-right">
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="{{url('single')}}"><img class="img-responsive " src="{{asset("/")}}images/r2.jpg" alt=""></a>
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="{{url('single')}}">Lorem ipsum dolor </a></h6>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="{{url('single')}}"><img class="img-responsive " src="{{asset("/")}}images/r3.jpg" alt=""></a>
										</div>
										<div class="recent-right">
								...
								<div class="cat-img">
									<img class="img-responsive " src="{{asset("/")}}images/45.jpg" alt="">
								</div>
							</div>
							<div class="col-md-9 product-agileinfon-grid1">
								<div class="product-agileinfon-top">
									<div class="col-md-6 product-agileinfon-top-left">
										<img class="img-responsive " src="{{asset("/")}}images/img3.jpg" alt="">
									</div>
									<div class="col-md-6 product-agileinfon-top-left">
										<img class="img-responsive " src="{{asset("/")}}images/img4.jpg" alt="">
									</div>
									<div class="clearfix"></div>
								</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{asset("/")}}images/s6.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{asset("/")}}images/s5.jpg" class="img-responsive"  alt="">
																	</div>
																</a>
															</figure>
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{asset("/")}}images/s8.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{asset("/")}}images/s7.jpg" class="img-responsive"  alt="">
																	</div>
																</a>
															</figure>
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{asset("/")}}images/s10.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{asset("/")}}images/s9.jpg" class="img-responsive"  alt="">
																	</div>
																</a>
															</figure>
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{asset("/")}}images/s12.jpg" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{asset("/")}}images/s11.jpg" class="img-responsive"  alt="">
																	</div>
																</a>
															</figure>
														</div>
